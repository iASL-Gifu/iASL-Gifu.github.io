...
async function initResearchPage() {
    ...
    texts.forEach(md => {
      ...
      section.innerHTML = `
        <article class="panel__wrapper">
          <div class="panel__content c-yellow">
            <h1 class="panel__headline">
              ${meta.title || "テーマ未入力"}
            </h1>
            <div class="panel__block"></div>
            <div class="panel__content__flex">
              <div class="panel__content__left">
                <img src="${meta.image_for_lists || '/img/research/calypso.jpg'}" alt="" loading="lazy">
              </div>

              <div class="panel__content__right">
      ...
      section.querySelector(".panel__content")
        ?.classList.add("panel__content--active");
  ...
  if (!container.dataset.bound) {
    container.addEventListener("click", (e) => {
      const wrapper = e.target.closest(".panel__wrapper");
      if (!wrapper) return;
